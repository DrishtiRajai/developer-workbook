...
// Show custom number of Projects on Projects Archive Page
function tl_portfolio_page( $query ) {
    if ( !is_admin() && $query->is_main_query() && is_post_type_archive( 'portfolio' ) ) {
            $query->set( 'posts_per_page', '9' );
    }
}
add_action( 'pre_get_posts', 'tl_portfolio_page' );

/*Shortcode for displaying Portfolios in a grid */

// Register the shortcode
add_shortcode('md-portfolio-list', 'md_portfolio_list_shortcode');

// Shortcode function
function md_portfolio_list_shortcode($atts) {
                ...
                <div class="portfolio-item">
                    ...
                    if ($types && !is_wp_error($types)) {
                        ...
                        foreach ($types as $type) {
                            $type_links[] = '<a href="' . esc_url(get_term_link($type->term_id)) . '">' . esc_html($type->name) . '</a>';
                        }
